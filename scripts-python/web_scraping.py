...
cap_bursatil = []
for row in rows:
  empresa.append(row.find_all('td')[1].text)
  pais.append(row.find_all('td')[2].text)
  sector.append(row.find_all('td')[3].text)
  cap_bursatil.append(row.find_all('td')[4].text)
